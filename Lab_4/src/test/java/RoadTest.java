...
public class RoadTest {
    ...
    public void setUp() throws Exception {
        road = new Road();
        Taxi taxi = new Taxi("Suzuki_vitara", 4);
        taxi.download(new Human("Ugin", "Usyk", 33));
    ...
    public void testFreePlaces() throws Exception {
        ...
        policeCar.download(new Policeman("Den", "Pechalnuy", 30, PoliceTypePassenger.PRIVATE));
    }
